...
public class Equation {
    ...
    Equation(String number){
        double value = parseString(number);
        this.value = value;
    }
    public Equation setValueTo(String number){
        double value = parseString(number);
        this.value = value;
        return this;
    }
    public Equation plus(String number){
        double value = parseString(number);
        this.value += value;
        return this;
    }
    public Equation minus(String number){
        double value = parseString(number);
        this.value -= value;
        return this;
    }
    public Equation times(String number){
        double value = parseString(number);
        this.value *= value;
        return this;
    }
    public Equation dividedBy(String number){
        double value = parseString(number);
        this.value /= value;
        return this;
    }
    public Equation remainderOf(String number){
        double value = parseString(number);
        this.value %= value;
        return this;
    }
    public Equation raisedToThePowerOf(String number){
        double value = parseString(number);
        this.value = Math.pow(this.value, value);
        return this;
    }
    public Equation toThePowerOf(String number){
        double value = parseString(number);
        this.value = Math.pow(this.value, value);
        return this;
    }
    public Equation toTheLogOf(){
        this.value = Math.log(this.value);
        return this;
    }
    public Equation toTheLogOfBase(String number){
        double value = parseString(number);
        this.value = Math.log(this.value) / Math.log(value);
        return this;
    }
    public Equation absoluteValue(){
        this.value = Math.abs(this.value);
        return this;
    }
    public Equation roundedDown(){
